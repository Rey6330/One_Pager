...
export const mockCompetitors: { [key: string]: CompetitorData[] } = {
  'AAPL': [
    { name: 'Samsung', marketShare: 20.8, trend: 'down' },
    { name: 'Xiaomi', marketShare: 12.9, trend: 'up' },
    { name: 'Google', marketShare: 8.2, trend: 'stable' },
    { name: 'OnePlus', marketShare: 3.1, trend: 'up' }
  ]
};
